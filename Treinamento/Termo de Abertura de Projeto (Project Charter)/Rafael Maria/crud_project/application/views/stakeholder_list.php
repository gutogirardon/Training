...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<span class="pull-right"><a href="<?php echo base_url(); ?>index.php/stakeholder/addnew" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New Stakeholder</a></span><br><br>
